...
def non_max_suppression(bboxes, iou_threshold, threshold, box_format="midpoint", iou_mode = "IoU"):
    """
...
def mean_average_precision(
    pred_boxes, true_boxes, iou_threshold=0.5, box_format="midpoint", num_classes=20, iou_mode="IoU"
):
    """
    Video explanation of this function:
...
def plot_couple_examples(model, loader, thresh, iou_thresh, anchors, iou_mode="IoU"):
    ...
    for i in range(batch_size):
        nms_boxes = non_max_suppression(
            bboxes[i], iou_threshold=iou_thresh, threshold=thresh, box_format="midpoint", iou_mode=iou_mode
        )
